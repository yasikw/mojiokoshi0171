...
import { TranscriptionTabs } from './TranscriptionResult/TranscriptionTabs';
import { TranscriptionContent } from './TranscriptionResult/TranscriptionContent';
import { useTranscriptionTabs } from './TranscriptionResult/hooks/useTranscriptionTabs';
